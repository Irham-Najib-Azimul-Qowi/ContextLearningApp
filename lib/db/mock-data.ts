...
export const INITIAL_SCHOOLS: School[] = [
  ...
  {
    id: "school-smp04-balikpapan",
    code: "SCH-SMP004",
    slug: "smp-04-balikpapan",
    name: "SMP Negeri 4 Balikpapan",
    educational_level: "SMP",
    npsn: "30401889",
    address: "Jl. Mayjend Sutoyo No. 45, Balikpapan",
    province: "Kalimantan Timur",
    ...
    longitude: 116.8312,
    region_id: "region-samarinda",
    description: "Sekolah Adiwiyata mandiri dengan kurikulum konservasi bakau dan maritim Teluk Balikpapan.",
    local_characteristics: "Kawasan pesisir industri kilang minyak, pelabuhan Semayang, dan hutan mangrove dengan fauna bekantan.",
    verification_status: "pending_verification",
    status: "active",
    created_by: "teacher-demo-03",
    created_at: "2026-02-10T08:30:00Z",
    updated_at: "2026-02-10T08:30:00Z",
  },
  {
    id: "school-sd-minomartani-sleman",
    code: "SCH-SD003",
    slug: "sd-minomartani-1-sleman",
    name: "SD Negeri Minomartani 1 Sleman",
    educational_level: "SD",
    npsn: "20403321",
    address: "Jl. Plosokuning Raya No. 12, Minomartani",
    province: "DI Yogyakarta",
    regency: "Kabupaten Sleman",
    district: "Ngaglik",
    village: "Minomartani",
    ...
    longitude: 110.4012,
    region_id: "region-sleman",
    description: "Sekolah dasar ramah anak di kawasan sub-urban berbasis budidaya perikanan air tawar dan pertanian organik.",
    local_characteristics: "Sentra kolam mina padi gurami, kebun salak lereng Merapi, dan peninggalan Masjid Pathok Negoro Plosokuning.",
    verification_status: "pending_verification",
    status: "active",
    created_by: "teacher-demo-04",
    created_at: "2026-02-14T10:15:00Z",
    updated_at: "2026-02-14T10:15:00Z",
  },
  {
    id: "school-sma02-tenggarong",
    code: "SCH-SMA002",
    slug: "sma-02-tenggarong",
    name: "SMA Negeri 2 Tenggarong",
    educational_level: "SMA",
    npsn: "30402110",
    address: "Jl. Pesut No. 8, Tenggarong",
    province: "Kalimantan Timur",
    ...
    longitude: 116.9856,
    region_id: "region-samarinda",
    description: "Sekolah rujukan berwawasan pelestarian budaya kesultanan Kutai Kartanegara Ing Martadipura.",
    local_characteristics: "Kawasan cagar budaya Museum Mulawarman, Pulau Kumala, dan tradisi pesta adat Erau tepian Mahakam.",
    verification_status: "pending_verification",
    status: "active",
    created_by: "teacher-demo-05",
    created_at: "2026-02-18T14:20:00Z",
    updated_at: "2026-02-18T14:20:00Z",
  },
  {
    id: "school-sd006-samarinda",
    code: "SCH-SD006",
    slug: "sd-006-samarinda-seberang",
    name: "SD Negeri 006 Samarinda Seberang",
    educational_level: "SD",
    npsn: "30406554",
    address: "Jl. Bung Tomo No. 77, Samarinda Seberang",
    province: "Kalimantan Timur",
    regency: "Kota Samarinda",
    ...
    longitude: 117.1389,
    region_id: "region-samarinda",
    description: "Sekolah dasar sentra kerajinan sarung tenun tradisional Samarinda dan perkapalan sungai.",
    local_characteristics: "Kawasan perajin sarung tenun Samarinda asli, dermaga tambangan kapal klotok, dan Masjid Tertua Shiratal Mustaqiem.",
    verification_status: "pending_verification",
    status: "active",
    created_by: "teacher-demo-06",
