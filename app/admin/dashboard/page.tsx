  ...
  return (
    <AdminWorkspaceShell activeGroupId="dashboard">
      <div className="space-y-8 max-w-7xl mx-auto pb-12">
        {/* Welcome Hero Banner */}
        <div className="bg-[#51465B] rounded-[28px] sm:rounded-[36px] p-6 sm:p-8 text-white shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              <Link
                ...
                className="px-5 py-3 rounded-2xl bg-[#FFD36D] hover:bg-[#ffe082] text-[#23212A] font-black text-xs shadow-md transition-transform active:scale-95 flex items-center gap-2 shrink-0"
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Card 1: Users */}
          <div className="bg-white rounded-[24px] border border-[#E9E5E8] p-5 shadow-xs flex items-center justify-between">
            <div>
              ...
              <span className="text-[11px] text-[#51465B] font-semibold mt-0.5 block">
                Guru & Murid SD
              </span>
            </div>
            <div className="w-12 h-12 rounded-2xl bg-[#FAF7F3] border border-[#E9E5E8] text-[#51465B] flex items-center justify-center font-bold">
          ...
          <div className="bg-white rounded-[24px] border border-[#E9E5E8] p-5 shadow-xs flex items-center justify-between">
            <div>
              ...
              <span className="text-[11px] text-[#756F7A] font-semibold mt-0.5 block">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link
              href="/admin/users"
              className="p-5 rounded-[24px] bg-white border border-[#E9E5E8] hover:border-[#51465B] shadow-xs transition-all flex items-center justify-between group"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-[#756F7A]">Kelola akun Guru, Murid, dan peran akses</p>
                </div>
              </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#E9E5E8]">
                {recentLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-[#FAF7F3]/60 transition-colors">
                    ...
                    <td className="py-3">
                      <span className="font-mono text-[11px] px-2 py-0.5 rounded-full bg-[#51465B]/10 text-[#51465B] font-bold">
                        {log.action}
                      </span>
                    </td>
