  ...
  return (
    <AdminWorkspaceShell activeGroupId="users">
      <div className="space-y-6 max-w-7xl mx-auto pb-12">
        ...
        {/* Search */}
        <div className="bg-white rounded-[24px] border border-[#E9E5E8] p-4 shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filtered.map((sch) => (
            <div
              key={sch.id}
              className="bg-white rounded-[24px] border border-[#E9E5E8] p-6 shadow-xs flex flex-col justify-between"
            >
              <div>
                ...
                <p className="text-[11px] text-[#756F7A] line-clamp-2 bg-[#FAF7F3] p-2.5 rounded-xl border border-[#E9E5E8] mb-4">
                  {sch.address}
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-[#E9E5E8] flex items-center justify-between text-xs text-[#756F7A]">
                ...
                <div>
                  <span className="font-bold text-[#23212A]">{sch.teacher_count}</span> Guru
                </div>
                <div>
                  <span className="font-bold text-[#23212A]">{sch.student_count}</span> Murid
                </div>
              </div>
            </div>
          ))}
